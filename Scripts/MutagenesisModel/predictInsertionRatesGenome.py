...
# this script predicts insertion rates for every single TTAA / TA site in the genome
...
#read model 
trained_model = joblib.load(open(snakemake.input["predict_insertion_model"], 'rb'))
...
#### we need the sharae of TTAA / TA sites used for training the mutagenesis model among all TTAA / TA sites in the genome 
