...
normalSkin<-as.data.frame(read_xlsx("/s/project/transposon/Output/Snakemake/Input/normal_skin.xlsx"))
...
SB_Granges<-insertion_table_to_Granges(normalSkin)
...
saveRDS(SB_Granges_correct, "/s/project/transposon/Output/Snakemake/normalSkin/correct_ranges.RData")
