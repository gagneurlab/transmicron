...
saveRDS(PiggyBac_Granges_correct, "/s/project/transposon/Output/Snakemake/TALL/correct_ranges.RData")


test<- sample(1:nrow(bm), 100000)
ggseqlogo(consensusMatrix(bm[test,]))
