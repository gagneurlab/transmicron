...
cuSCC<-as.data.frame(read_xlsx("/s/project/transposon/Output/Snakemake/Input/cusc.xlsx"))
...
SB_Granges<-insertion_table_to_Granges(cuSCC)
...
write.table(SBDT, "/s/project/transposon/Output/PublishedPipeline/Input/BEDInsertionTesting/cuSCC.BED")
write.table(SBDT, "/s/project/transposon/Output/PaperPipeline/Input/BEDInsertionTesting/cuSCC.BED")
