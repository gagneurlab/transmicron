...
PiggyBac_insertions_edited<-PiggyBac_insertions
#analyze
...
write.table(PiggyBacDT, "/s/project/transposon/Output/PublishedPipeline/Input/BEDInsertionTesting/DLBCLPBtail.BED")
write.table(PiggyBacDT, "/s/project/transposon/Output/PaperPipeline/Input/BEDInsertionTesting/DLBCLPBtail.BED")
