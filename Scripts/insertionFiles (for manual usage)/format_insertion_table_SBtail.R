...
write.table(SBDT, "/s/project/transposon/Output/PublishedPipeline/Input/BEDInsertionTesting/DLBCLSBtail.BED")
write.table(SBDT, "/s/project/transposon/Output/PaperPipeline/Input/BEDInsertionTesting/DLBCLSBtail.BED")